...
public sealed class ImageSource : MonoBehaviour
{
    ...
    [SerializeField] bool _vFlip = false;
    ...
    {
        if (_sourceType == SourceType.Video)
            Blit(GetComponent<VideoPlayer>().texture, _vFlip);
    ...
    public void ForceBlit () {
        Blit (_texture, _vFlip);
    }

    public void SetOutputResolution (Vector2Int outputResolution) {
